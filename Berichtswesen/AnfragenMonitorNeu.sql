select distinct
--Bericht
qb.FK_VORHANDENE_DFK as PAT_ID,v.TUMOR_ID,qb.FK_VORHANDENE_DLFD as  DOKUMENTLFDNR,qb.FK_VORHANDENE_DDAT as DATENART,
b.EVENT_DATUM as Anfrage_Datum,extract(YEAR from b.EVENT_DATUM) as Anfrage_Jahr,
--(extract(YEAR from b.Datum)||'_'||extract(QUARTER from b.Datum) )as Anfrage_QuartalJahr,
to_char(b.EVENT_DATUM,'YYYY_Q')as Anfrage_QuartalJahr,
to_char(b.EVENT_DATUM,'YYYY_MM')as Anfrage_MonatJahr,
extract(MONTH from b.EVENT_DATUM) as Anfrage_Monat
,b.EVENT_TYP,
 --Anfrage
...
left outer join UKE_EVENT_LOG b
...
and (b.EVENT_TYP='UKE_KKR_Datenanfrage' or b.EVENT_TYP='UKE_KKR_Datenanfrage_Erinnerung')
