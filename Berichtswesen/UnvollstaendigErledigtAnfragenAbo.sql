select distinct 
de.TEXT30 Dokumentar,b.EMAIL,sysdate-6 as Stichtag
...
and qb.FK_QUALITATIVE_ID =5 --nur "unvollständig erledigt" werden  abgefragt
and qb.TAG_DER_MESSUNG >=sysdate-6--:startdatum or :startdatum is null)
