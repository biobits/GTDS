...
(
  ...
  P_ABSCHLUSSSTICHTAG IN DATE, -- für alle mit Status 'Erinnerung' älter /gleich Datum
  ...
  --BEGIN
    ...
    LOOP
      ...
      exit when p_intrec%NOTFOUND;
        ...
        --Erstellung des Berichst in Tabelle BERICHT loggen (nur für offene und verschickte)
        ...
        -- und "unvollständig erledigt(5)" setzen 
        ...
        set FK_QUALITATIVE_ID=case when p_indiv.P_FK_QUALITATIVE_ID =1 then 2 -- "offen" wird auf "Verschickt" gesetzt
                                    ...
                                    when  p_indiv.P_FK_QUALITATIVE_ID =4 then 5 --"Erinnerung" wird auf "unvollständig erledigt" gesetzt
                                    end
      ...
      UKE_SP_INSERT_EVENT(p_indiv.P_GTDS_ID,p_indiv.P_TUMOR_ID,p_indiv.P_DATENART,p_indiv.P_LFDNR,SYSDATE,'MERKMAL',
                              'Anfrage Zertifizierung','update',case when p_indiv.P_FK_QUALITATIVE_ID =1 then 'verschickt' -- "offen" wird auf "Verschickt" gesetzt
                                    ...
                                    when  p_indiv.P_FK_QUALITATIVE_ID =4 then 'unvollständig erledigt' --"Erinnerung" wird auf "unvollständig erledigt" gesetzt
...
--        -- nur für die Daten des Berichts zuständig ist
--        update QUALITATIVER_BEFUND
