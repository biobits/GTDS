...
--CREATE OR REPLACE FORCE VIEW "OPS$TUMSYS"."UCCH_SchnittstelleArbeitsliste"
--as

  CREATE OR REPLACE FORCE VIEW "OPS$TUMSYS"."UCCH_SchnittstelleArbeitsliste" ("TYP", "PATIENTEN_ID", "GTDS_ID", "IM_GTDS", "EXTERNE_DIAGNOSEN", "SCHNITTSTELLEN_FILTER", "DIAGNOSE_TUMOR", "DIAGNOSEDATUM", "DIAGNOSEJAHR", "ARBEITTSLISTE_DATUM", "ARBEITSLISTE_TUMOR", "ARBEITSLISTE_BEMERKUNG", "THERAPIE_2017", "THERAPIE_2018", "BEHANDELT_IN_2017", "BEHANDELT_IN_2018", "MAX_EXT_DAT", "ANZAHL") AS 
